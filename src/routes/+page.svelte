...
<div class="content">
	...
	<div class="instagram">
		<blockquote
			...
			style="background:#FFF; border:none; border-radius:0px; box-shadow:none; margin:0 0 12px; min-width:326px; padding:0px; width:100%;"
		>
			<a
			...
			>
				...
				<div class="insta-middle">
					...
					<div>Click to view full profile on Instagram</div>
				</div>
